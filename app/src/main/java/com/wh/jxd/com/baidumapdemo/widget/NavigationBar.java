...
public class NavigationBar extends RelativeLayout {
	...
	private void init() {
		LayoutInflater.from(getContext()).inflate(R.layout.layout_navigation_bar, this, true);
		...
		mTitleImaBtn = (ImageButton) findViewById(R.id.img_btn_navigation_title);
	...
	public void setTitleImage(int resId) {
		...
		mTitleImaBtn.setVisibility(View.VISIBLE);
		mTitleImaBtn.setImageResource(resId);
	}

	public void setLeftBack() {
		mLeftTextView.setVisibility(View.INVISIBLE);
		mLeftImgBtn.setVisibility(View.VISIBLE);
		mLeftImgBtn.setImageResource(R.drawable.fanhui);
	}
	...
	public void setTitle(String string) {
		mTitleImaBtn.setVisibility(INVISIBLE);
